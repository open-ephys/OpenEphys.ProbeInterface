...
namespace OpenEphys.ProbeInterface.NET
{
    ...
    public sealed class Contact
    {
        ...
        /// <summary>
        /// Gets the x-position of the contact centre.</summary>
        ...
        /// <paramref name="store"/> is shared across all contacts on the same probe; mutations through any
        ...
        /// <typeparamref name="T"/>. Returns the default value of <typeparamref name="T"/> if the key is
        ...
        /// <typeparamref name="T"/> if the key is absent or the value is null.
        /// </returns>
        ...
        /// <param name="value">The annotation value to annotationStore for this contact.</param>
        ...
        /// </summary>
        /// <param name="key">The annotation key to clear.</param>
        /// <returns>True if the key was found; false if it was absent.</returns>
